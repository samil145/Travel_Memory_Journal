...
open class ImagePickerController: UIViewController {
  ...
  open lazy var galleryView: ImageGalleryView = { [unowned self] in
    let galleryView = ImageGalleryView(pickerConfiguration: self.pickerConfiguration)
  ...
  open lazy var bottomContainer: BottomContainerView = { [unowned self] in
    let view = BottomContainerView(pickerConfiguration: self.pickerConfiguration)
  ...
  open lazy var topView: TopView = { [unowned self] in
    let view = TopView(pickerConfiguration: self.pickerConfiguration)
  ...
  lazy var cameraController: CameraView = { [unowned self] in
    let controller = CameraView(pickerConfiguration: self.pickerConfiguration)
  ...
  @objc public required init(pickerConfiguration: PickerConfiguration = PickerConfiguration()) {
